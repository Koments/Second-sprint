...
function Clock() {
    ...
    const start = () => {
        ...
        let timerId = setInterval(() => setDate(new Date(restoreState('hw9-date', Date.now()))), 1000);
        console.log(timerId)
    ...
    const stringDate = date.toLocaleDateString('RU', {
        ...
        month: '2-digit',
        year: 'numeric'
    }).replace(/\//g, '.') || ''; // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
